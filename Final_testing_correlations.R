...
ggplot(court_terr_data, aes(x = sp_binary_terr, fill = sp_courtship)) +
  ...
  scale_fill_manual(values = c("Yes" = "grey55", "No" = "grey19")) +
  theme_minimal() +
  theme(panel.grid=element_blank(),
        axis.line = element_line(color = "black", size = 0.5),
        axis.text = element_text(size = 12),
...
ggplot(ovi_terr_data, aes(x = sp_binary_terr, fill = sp_ovi)) +
  ...
  scale_fill_manual(values = c("Endophytic" = "grey55", "Exophytic" = "grey19")) +
  theme_minimal() +
  theme(panel.grid=element_blank(),
        axis.line = element_line(color = "black", size = 0.5),
        axis.text = element_text(size = 12),
...
ggplot(lo_len_terr_data, aes(x = sp_binary_terr, fill = sp_lo_len)) +
  ...
  scale_fill_manual(values = c("Lotic" = "grey55", "Lentic" = "grey19")) +
  theme_minimal() +
  theme(panel.grid=element_blank(),
        axis.line = element_line(color = "black", size = 0.5),
        axis.text = element_text(size = 12),
...
sp_redlist_cat_ordered<-sp_redlist_cat %>%
  dplyr::select(sn, redlist_cat_final)
...
#manually calculate
beta_both<- 0.41714 #estimate for both
se_both<- 0.70543 #estimate for both
